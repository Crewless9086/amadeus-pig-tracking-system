...
- Bounded repair: one initial authorization read plus at most four retries, two seconds apart, only for HTTP 429, HTTP 5xx or transport failures. HTTP 401/403 and every other deterministic 4xx fail after the first read. The maximum envelope is five reads and approximately eight seconds of retry wait; exhaustion remains fail-closed. This creates no bypass, replay or farm effect.
