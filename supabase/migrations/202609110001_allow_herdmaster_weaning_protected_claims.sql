-- Admit the shared HERDMASTER weaning executor through the canonical
...
values (
  '202609110001_allow_herdmaster_weaning_protected_claims',
  'Admit exact-preview HERDMASTER weaning claims; no farm facts or delegated permissions are changed.'
)
