...
module.exports = defineConfig({
  testDir: "tests",
  testMatch: ["oom_sakkie_playwright_behavior.spec.js", "charlie_mission_control_playwright.spec.js", "beacon_live_stock_visual_proof.spec.js", "beacon_meat_launch_visual_proof.spec.js", "beacon_sam_attribution_frontend.spec.js"],
  timeout: 30000,
  use: {
    baseURL,
