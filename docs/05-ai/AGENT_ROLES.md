...
| Prisma/Beacon | Public/social demand-generation drafts for meat launch campaigns. | Draft-only until owner approves public posting and channel rules. Existing system docs call this role `Beacon`; owner may refer to it as `Prisma`. |
