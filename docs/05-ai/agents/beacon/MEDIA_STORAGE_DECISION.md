...
- Implement the owner-approved `BEACON-MEDIA-INTAKE-1` direction: existing OOM
  SAKKIE Telegram bot -> private raw intake -> hash/provenance/media
  understanding -> visual Farm App review. See
