...
- 2026-06-22 correction after Chatwoot conversation 1816: vague pork phrases such as "pig meat", "do you sell meat", "carcass", and "half pig" must not loop the generic intro. The backend now tracks vague meat interest earlier, refreshes the same lead's latest interest context, and asks one meat-specific next question while keeping quote/deposit/booking gates locked.
