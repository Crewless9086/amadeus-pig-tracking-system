...
This folder holds business-model and launch-planning documents. Keep deep strategy and operating assumptions separate from short build plans.
...
Do not turn the large business model into a task tracker. Put active build order in `docs/00-start-here/NEXT_STEPS.md` and short sales launch context in `MEAT_SALES_LAUNCH_PLAN.md`.
