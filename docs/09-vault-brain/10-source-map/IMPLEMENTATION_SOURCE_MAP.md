...
Current P0 operating recovery:

- controlling plan: `planning/SAM_LIVE_STOCK_P0_OPERATING_RECOVERY_2026-07-27.md`;
- routes to inspect: `/api/sales/channels/chatwoot/sam-live-stock/inbound`, `/api/sales/channels/chatwoot/sam-live-stock/policy`, `/api/sales/channels/chatwoot/sam-live-stock/launch-readiness`, `/api/sales/channels/chatwoot/sam/owner-inbox`, `/api/sales/channels/chatwoot/sam/owner-inbox/page`, `/api/sales/channels/chatwoot/sam/owner-inbox/reconcile`, `/api/sales/channels/chatwoot/sam/owner-inbox/ownership`, `/sales-dashboard`, `/sales-availability`, `/orders`, `/api/order-intake/context`, `/api/order-intake/update`, `/api/orders/active-customer-context`, `/api/orders/available-pigs`, `/api/master/orders`, `/api/master/order-lines`, `/api/pig-weights/sales-dashboard`, `/api/pig-weights/pig-allocation-readiness`;
- Vault doctrine: `docs/09-vault-brain/02-agents/sales/SAM.md`, `docs/09-vault-brain/02-agents/sales/LIVE_PIG_SALES_AGENT.md`, `docs/09-vault-brain/03-business/LIVE_PIG_SALES.md`, `docs/09-vault-brain/04-workflows/SAM_LIVE_STOCK_P0_RECOVERY.md`, `docs/09-vault-brain/04-workflows/SAM_LIVE_STOCK_SALES_WORKFLOW.md`, `docs/09-vault-brain/04-workflows/BEACON_LIVE_STOCK_AWARENESS_WORKFLOW.md`, `docs/09-vault-brain/05-playbooks/SAM_LIVE_STOCK_HUMAN_SALES_PLAYBOOK.md`, `docs/09-vault-brain/08-business-rules/LIVE_STOCK_SALES_RULES.md`, `docs/09-vault-brain/09-examples/SAM_LIVE_STOCK_GOLD_STANDARD_REPLIES.md`;
- code: `modules/sales/sam_owner_work_queue.py`, `modules/sales/sam_owner_reply_window.py`, `modules/sales/sam_owner_ownership_resolution.py`, `modules/sales/sam_live_stock_launch_control.py`, `modules/sales/sam_live_stock_runtime.py`, `modules/sales/sam_sales_router.py`, `modules/sales/sales_transaction_routes.py`, `modules/pig_weights/pig_weights_service.py`, `modules/orders/order_intake_service.py`, `modules/orders/order_service.py`, `modules/orders/order_write.py`, `modules/orders/order_routes.py`, `modules/sales/sales_transaction_read.py`, `modules/sales/sales_transaction_create.py`, `templates/sam-owner-inbox.html`, `static/js/samOwnerInbox.js`, `static/css/samOwnerInbox.css`;
- tests: `tests/test_sam_owner_work_queue.py`, `tests/test_sam_owner_work_queue_postgres.py`, `tests/test_sam_owner_reply_window.py`, `tests/test_sam_owner_ownership_resolution.py`, `tests/test_sam_owner_ownership_resolution_postgres.py`, `tests/test_sam_live_stock_launch_control.py`, `tests/test_sam_live_stock_runtime.py`, `tests/test_sam_sales_router.py`, `tests/test_sales_transaction_routes.py`, `tests/test_frontend_route_contracts.py`, `tests/test_order_intake_service.py`, `tests/test_order_routes.py`, `tests/test_order_service_reservation.py`, `tests/test_sales_transaction_read.py`, `tests/test_pig_allocation_readiness_service.py`;
...
- rule: repair complete conversation coverage, projection freshness, guided selling, and durable intake before enabling wider business writes. Exact owner-approved sends may remain enabled. Intake and draft-order gates require bounded canaries. Reservation, payment confirmation, stock mutation, final promises, and general automatic sending remain separately blocked.
