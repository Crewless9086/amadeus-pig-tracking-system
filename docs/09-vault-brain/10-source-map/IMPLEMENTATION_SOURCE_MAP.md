...
Current backend-native and Level 1 surface:
...
- rule: customer guidance translates internal categories into the standing
  plain-language weight groups before asking a vague buyer to choose. Evidence
  is claim-scoped: missing evidence removes only unsupported claims and does
  not suppress safe clarification. Level 1 customer sends remain governed by
  exact identity, chronology, review, durable claim-before-send and provider
  outcome rails. Order creation, stock reservation, binding quotes, money and
  farm mutations remain protected.
