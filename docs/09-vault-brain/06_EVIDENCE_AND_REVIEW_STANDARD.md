...
Nothing is "done" because code was written. It is review-ready only when the owner can see what changed, why it works, what remains risky, and what decision is needed.
...
- `node --check static/js/charlieMissionControl.js`
...
## Blocked Mission Evidence

If blocked:

- state blocker plainly;
- state last successful stage;
- show attempts made;
- show unresolved blockers;
- recommend exact next owner/system action.
