...
| Beacon | Marketing Department Leader. Coordinates Strategy, Creative, Media Librarian, Scheduler, and Performance Analyst capabilities across livestock, meat, and later approved business lanes. Owns campaign targets, brand consistency, demand quality, media, channel recommendations, spend recommendations, and learning. | Private media and campaign foundations are live. Exact Facebook text/image posting requires explicit owner confirmation. Scheduling, paid spend, creative-provider execution, and reusable campaign authority remain disabled until separately approved. |
