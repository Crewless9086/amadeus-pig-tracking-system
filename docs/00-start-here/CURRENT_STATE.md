...
- Remaining Google Sheets dependencies are now narrower: litter lifecycle/piglet correction workflows, legacy setup/import scripts, and formula-specific farm/litter attention replacement work.
