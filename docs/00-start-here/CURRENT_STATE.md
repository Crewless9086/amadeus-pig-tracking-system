...
- Phase 9.5 is implemented locally and test-verified: the dashboard monthly sales count now tracks total sales exits plus livestock, slaughter/abattoir, and future meat streams from `PIG_MASTER` exits. Deploy/browser verification is next.
