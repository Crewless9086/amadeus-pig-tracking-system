...
- `docs/00-start-here/CLAUDE_REVIEW_HANDOFF.md` now has a filled current-review prompt for the Oom Sakkie 10.6 through 10.7B batch. Use it for the next Claude review instead of the older generic template.
