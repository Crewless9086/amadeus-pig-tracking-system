...
- Phase 9.5B1 is implemented locally and awaiting deploy/browser verification: dashboard wording now says `Sales Exits This Month`, `Livestock Exits`, `Slaughter Exits`, and `Meat Exits`; backend counts are unchanged.
