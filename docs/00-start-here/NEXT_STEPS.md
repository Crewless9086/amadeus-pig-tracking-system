...
- Litter lifecycle/piglet correction workflows, formula-specific newborn-health attention replacement, and any remaining legacy setup/import scripts remain outside the current safe cutover until explicit Supabase services and tests exist.
