...
Repository revision:
[`3341fe4`](https://github.com/Crewless9086/amadeus-pig-tracking-system/commit/3341fe44ce449f02430662dc559aad71319bb81a).
...
| --- | --- | --- | --- | --- | --- |
| **CHARLIE / CORE** | Governed owner mission system. Doctrine: [`CHARLIE_CORE.md`](../09-vault-brain/01-identity/CHARLIE_CORE.md) and [`CHARLIE_MISSION_WORKFLOW.md`](../09-vault-brain/04-workflows/CHARLIE_MISSION_WORKFLOW.md). | `modules/charlie/*`, runner, supervisor, watchdog, mission store and execution bridge. | Yes / Yes / Partial / Yes / Partial / No. Adaptive orchestration merged through PR [#489](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/489); exact deployment, governed promotion, restart and live mission exercise are unproven at this cut. | The merge changes implementation and source-map contracts, not live mission authority. Old protected-pause PRs #453-#455 remain failed/conflicting; #445 remains stale and unwired. | PR #489 updated the implementation source map; this reconciliation preserves it without further edit. Evidence date: 2026-07-25. |
...
- **ROOTLINE:** Level 1 owner route is operational. Valve control, IFTTT
  ...
  migration is unapplied.
- **CORE:** Phase B adaptive orchestration is merged through PR #489. Exact
  deployment, governed promotion, restart and live mission exercise remain
  unproven; merged code is not operational authority. PR-ready lifecycle
  evidence and old overlapping candidates are not product truth.
...
| --- | --- | --- |
| **Current and actionable** | [#488](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/488), [#487](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/487), [#486](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/486), [#477](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/477) | All are open, clean candidates with exact-head CI passed. #488 is plan-only with migration unapplied; #487 is approval UI with migration unapplied; #486 is pre-production documentation only; #477 is this documentation reconciliation. None is operational merely because CI passed. |
