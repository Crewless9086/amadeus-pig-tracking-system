...
| --- | --- | --- |
| **Current and actionable** | [#486](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/486), [#477](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/477) | #486 is the clean, exact-scope StoryWorks verification-boundary candidate; it remains planning/pre-production only. #477 is this documentation-only reconciliation. PR #485 merged at the evidence cut and is no longer open. |
