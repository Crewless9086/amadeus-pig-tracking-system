...
| --- | --- | --- |
| **Current and actionable** | [#487](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/487), [#486](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/486), [#477](https://github.com/Crewless9086/amadeus-pig-tracking-system/pull/477) | #487 is the exact Beacon weekly owner-decision candidate with exact-head CI pending; it is not yet merge-ready or operational. #486 is the clean StoryWorks verification-boundary candidate and remains planning/pre-production only. #477 is this documentation reconciliation. |
