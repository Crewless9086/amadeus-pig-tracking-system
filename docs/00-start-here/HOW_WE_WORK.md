...
| **Current focus** | Deploy/browser-check `/pig/<pig_id>` lifecycle outcome, `/sales/slaughter/<sale_id>` pig-exit confirmation, and dashboard `Outcomes This Month` with safe known/test cases before real operational use. |
| **Current last verified** | **2026-06-02** - Phase 9.7D local checks passed: JS syntax, focused dashboard/frontend tests, route smoke, and full unittest suite at 320 tests. |
