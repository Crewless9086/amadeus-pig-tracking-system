...
`ConversationId` was added manually for Phase 1.9 and stores the Chatwoot conversation ID passed from `1.0` through `1.2` at draft creation time. It is used by the outbound approval/rejection notification workflow.
