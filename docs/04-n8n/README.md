...
| `1.5 - Outbound Document Delivery` | `workflows/1.5 - outbound-document-delivery/` | Planned/import pending | Receives backend document-delivery events and sends generated quote/invoice PDFs as Chatwoot attachments. |
