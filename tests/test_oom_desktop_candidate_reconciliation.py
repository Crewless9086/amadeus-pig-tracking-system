...
class ReconciliationTests(unittest.TestCase):
    ...
    def test_web_only_successor_rejects_scheduler_old_rollback_and_old_acceptance(self):
        for field in ("scheduler_effect", "cron_prohibition", "rollback", "old_acceptance"):
            m,a=json.loads(self.args["manifest_bytes"]),json.loads(self.args["approval_bytes"])
            contract=m["contract"]
            if field=="scheduler_effect":
