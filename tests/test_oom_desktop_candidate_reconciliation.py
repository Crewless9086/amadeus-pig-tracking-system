...
PREDECESSOR_PATHS = ['modules/oom_sakkie/general_manager_worker.py', 'tests/test_oom_sakkie_general_manager_delivery.py', 'tests/test_oom_sakkie_general_manager_postgres.py']
...
def arguments(child=None, parent=None, correction=None):
    ...
    manifest = {"version": adapter.VERSION, "mission_id": adapter.MISSION_ID, "parent_mission_id": adapter.PARENT_ID,
        "candidate": candidate, "generation": "synthetic-new-generation", "idempotency_key": "synthetic-retained-report-rebind",
...
class ReconciliationTests(unittest.TestCase):
    ...
    def test_exact_candidate_requires_approved_ancestry_and_exact_qualification_delta(self):
        ...
        self.assertEqual(adapter.APPROVED_RUNTIME_HEAD, "3f4733e7ee29c839e6d36dc44a81a4ca0142e803")
