...
PREDECESSOR_PATHS = ['.github/workflows/oom-sakkie-audit-rails.yml', 'modules/oom_sakkie/daily_farm_manager.py', 'modules/oom_sakkie/family_message_lifecycle.py', 'modules/telemetry/rootline_mixer_readiness_observer.py', 'scripts/oom_sakkie_morning_scheduler.py', 'tests/test_beacon_campaign.py', 'tests/test_beacon_public_livestock_content_policy.py', 'tests/test_oom_sakkie_daily_farm_manager.py', 'tests/test_oom_sakkie_daily_farm_manager_postgres.py', 'tests/test_oom_sakkie_family_message_lifecycle.py', 'tests/test_oom_sakkie_herd_morning_language.py', 'tests/test_oom_sakkie_morning_scheduler.py', 'tests/test_rootline_mixer_readiness_observer.py', 'tests/test_telegram_voice_ingress_postgres.py']
...
def fixtures():
    ...
    prior_contract = {"generation": "synthetic-old-generation", "base_sha": adapter.PREDECESSOR_BASE,
        ...
        "forbidden_effects": [f"cron_deploy_other_than:{adapter.SCHEDULER_SERVICE}", "farm_write", "hardware_command", "database_migration", "service_configuration_change"],
...
def arguments(child=None, parent=None, correction=None):
    ...
    manifest = {"version": adapter.VERSION, "mission_id": adapter.MISSION_ID, "parent_mission_id": adapter.PARENT_ID,
        "candidate": candidate, "generation": "synthetic-new-generation", "idempotency_key": "synthetic-manager-delivery-rebind",
...
class ReconciliationTests(unittest.TestCase):
    ...
    def test_blanket_cron_prohibition_is_restored_and_prior_scheduler_history_preserved(self):
        ...
        self.assertIn(f"cron_deploy_other_than:{adapter.SCHEDULER_SERVICE}", history["previous_record"]["metadata_json"]["mission_admission_contract"]["forbidden_effects"])
    ...
    def test_exact_candidate_requires_approved_ancestry_and_exact_qualification_delta(self):
        ...
        self.assertEqual(adapter.APPROVED_RUNTIME_HEAD, "5c3d51e427b96063b194545855c474dc34a8a80c")
