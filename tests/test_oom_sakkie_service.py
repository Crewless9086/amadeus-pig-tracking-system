...
class OomSakkieServiceTests(unittest.TestCase):
    ...
    def test_jarvis_owner_review_packet_is_read_only_batched_review(self):
        ...
        self.assertEqual(packet["current_review"]["scope"], "Oom Sakkie 10.6 through 10.9CK")
        self.assertIn("10.9CK", packet["current_review"]["scope"])
    ...
    def test_jarvis_owner_review_packet_tool_is_read_only(self):
        ...
        self.assertIn("10.9CK", result["summary"])
        ...
        self.assertEqual(result["llm_context"]["current_review"]["scope"], "Oom Sakkie 10.6 through 10.9CK")
