...
class SamLiveStockReplayTests(unittest.TestCase):
    ...
    def test_sanitized_vertical_slice_trace_preserves_evidence_unknowns_and_no_write_boundary(self):
        cases = [{
            ...
            "availability_rows": [
                {"pig_id": "SAN-W-01", "sex": "Female", "status": "Active", "on_farm": "Yes", "available_for_sale": "Yes", "sale_category": "Weaner", "current_weight_kg": 12},
                {"pig_id": "SAN-W-02", "sex": "Female", "status": "Active", "on_farm": "Yes", "available_for_sale": "Yes", "sale_category": "Weaner", "current_weight_kg": 12},
            ],
