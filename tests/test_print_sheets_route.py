...
class PrintSheetsRouteTests(unittest.TestCase):
    ...
    def test_mating_litter_record_route_loads_in_afrikaans(self):
        ...
        self.assertIn("Jonghok / Sog se hok".encode("utf-8"), response.data)
        self.assertIn("Huidige hok".encode("utf-8"), response.data)
        ...
        self.assertIn(b'pwr_mating_date', response.data)
