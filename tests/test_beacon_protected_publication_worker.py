...
from modules.beacon.protected_publication_worker import (
    run_protected_publication_cycle, validate_claimed_approval,
)
...
def test_success_publishes_once_and_concurrent_or_restarted_cycle_is_silent():
    ...
    def execute(payload, **kwargs): calls.append(payload); return {"success":True,"status":"facebook_page_post_sent","facebook_post_id":"42_7"},200
