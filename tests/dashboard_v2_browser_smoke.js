...
const fixtures = {
  "/api/telemetry/weather/current": { current: { temperature_c: 18, rain_today_mm: 2.3, rain_rate_mm_h: 0, wind_speed_kmh: 9, wind_gust_kmh: 14 }, source: { data_age_minutes: 2 }, summary: { headline: "Fresh and dry at the farm." } },
  "/api/telemetry/weather/forecast": { days: [{ forecast_date: "2026-08-10", temp_min_c: 9, temp_max_c: 20, rain_sum_mm: 0 }] },
  "/api/telemetry/power/current": { current: { battery_soc_pct: 74, solar_power_w: 2840, load_power_w: 690, grid_state: "off_grid" }, source: { data_age_minutes: 1 }, summary: { headline: "Battery and solar are healthy." } },
  "/api/telemetry/power/recent": { summary: { minimum_battery_soc_pct: 43, peak_solar_power_w: 3150 } },
  "/api/telemetry/irrigation/status": { current: { status: "Hold" }, today: { next_zone_name: "B Camp", plan: [{ zone_name: "B Camp", status: "Run later", planned_minutes: 60 }] }, source: { source: "canonical" }, operator_summary: { notes: ["Reassess after observed rain."] } },
  "/api/pig-weights/dashboard": { summary: { on_farm_pigs: 121, sows: 18, boars: 3, piglets: 54, lifecycle_sold_this_month: 18, lifecycle_dead_this_month: 1, lifecycle_removed_this_month: 0, sales_metrics: { recent_sales_value: 4470.51 } }, litter_attention: { items: [{ litter_id: "LIT-2026-1350", reason: "Weaning overdue", action_type: "review" }] } },
...
(async () => {
  ...
  assert.equal(await page.locator("#status_weather").textContent(), "18 °C · Dry");
