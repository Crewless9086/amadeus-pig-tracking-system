...
class PigManagementIntentEventMigrationTests(unittest.TestCase):
    ...
    def test_intent_migration_cannot_change_current_or_operational_state_or_add_browser_writes(self):
        prohibited = (
            "update public.pigs", "insert into public.pigs", "delete from public.pigs",
            "update public.orders", "insert into public.orders", "delete from public.orders",
            "update public.sales", "insert into public.sales", "delete from public.sales",
            "update public.reservations", "insert into public.reservations", "delete from public.reservations",
            "update public.slaughter", "insert into public.slaughter", "delete from public.slaughter",
            "create policy", "grant ",
        )
