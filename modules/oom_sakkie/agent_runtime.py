...
CURRENT_CLAUDE_REVIEW_SCOPE = "Oom Sakkie 10.6 through 10.9DD"
...
CURRENT_CLAUDE_REVIEW_FOCUS = [
    ...
    "Read-only Telegram gateway is token-gated, deterministic-only, cannot trigger outbound LLM calls, returns a caller-send reply payload only, and sends no Telegram message itself.",
