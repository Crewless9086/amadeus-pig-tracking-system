...
CURRENT_CLAUDE_REVIEW_CI_EVIDENCE_POLICY = {
    ...
    "recorded_at_utc": "2026-06-14T09:28:00Z",
...
CURRENT_CLAUDE_REVIEW_FOCUS = [
    ...
    "Ledger Sales Workbench now surfaces campaigns, outreach drafts, and Sam/Chatwoot send-design requests in the local web app; send-design requests are append-only review records only and cannot send customers, call Chatwoot/n8n, create orders, reserve/change stock, or dispatch agents.",
...
_AGENT_TOOLS = {
    ...
    "ledger": ("business_growth_brief", "sales_offer_brief", "sales_customer_draft", "ledger_sales_agent", "sales_campaign_status", "sales_outreach_draft_queue", "sales_send_design_status", "sales_dashboard", "meat_planning"),
