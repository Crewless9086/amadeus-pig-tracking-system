...
AGENT_TOOL_ALLOWLIST = {
    ...
    "builder": {"vault_read", "vault_write", "repo_read", "repo_write", "test_run", "git_commit", "git_push"},
    "tester": {"vault_read", "vault_write", "repo_read", "test_run"},
    "qa_red_team": {"vault_read", "vault_write", "repo_read", "test_run"},
    "security_reviewer": {"vault_read", "vault_write", "repo_read", "test_run"},
    "evidence_reviewer": {"vault_read", "vault_write", "repo_read", "test_run"},
    "product_reviewer": {"vault_read", "vault_write"},
    "business_reviewer": {"vault_read", "vault_write"},
    "reviewer": {"vault_read", "vault_write", "repo_read", "test_run"},
