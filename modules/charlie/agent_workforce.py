...
WORKFORCE_DEFINITIONS = (
    ...
    {"id": "oom-sakkie", "name": "Oom Sakkie", "team": "Farm Command", "role": "Operational read-only farm coordinator over governed specialist evidence.", "stage": "operational_v1", "registry_id": "oom-sakkie"},
    ...
    {"id": "ledger", "name": "Ledger", "team": "Business", "role": "Operational read-only commercial and price-evidence validator; broader finance intelligence remains planned.", "stage": "operational_v1", "registry_id": "ledger"},
...
CONNECTIONS = (
    ...
    ("sam-live-stock", "herdmaster", "requests stock evidence"),
    ("sam-live-stock", "ledger", "requests price evidence"),
