...
_CATALOGUE = (
    ...
    DocumentDefinition(
        ...
        "web.weight_report.v1", "HERDMASTER", "Transitional Supabase-first weight/pig reads with bounded Google Sheets fallback",
    ...
    DocumentDefinition(
        ...
        "web.mating_litter_record.v1", "HERDMASTER", "Transitional Supabase-first mating/litter reads with bounded Google Sheets fallback",
