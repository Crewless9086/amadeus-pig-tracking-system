...
from modules.sales.riversdale_auction import build_riversdale_auction_packet
...
def get_riversdale_auction_recommendation(today=None, confirmation=None, ledger_evidence=None, sam_demand=None, oom_sakkie_preparation=None):
