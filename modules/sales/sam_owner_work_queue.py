...
def observe_owner_work_inbound_event(
    ...
    *,
    ...
    """Persist the webhook fast-path observation without another HTTP read."""
    ...
    observation = build_owner_work_observation(
        {
            ...
            "custom_attributes": inbound.get("conversation_custom_attributes"),
