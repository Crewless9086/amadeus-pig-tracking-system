...
STRESS_SCENARIOS = [
    ...
    {
        "id": "complete_half_set_a_delivery_from_collection_wording",
        "category": "happy_path",
        "message": "Half carcass, Set A, Riversdale, delivery to 12 Test Street please. EFT is fine. Next available farm run.",
        "expected_facts": {
    ...
    {
        "id": "delivery_missing_timing",
        "category": "missing_fact",
        "message": "I want a half carcass Set A in Riversdale, delivery to 12 Test Street, EFT.",
        "expected_facts": {"product_type": "half_carcass", "delivery_or_collection": "delivery"},
    ...
    },
    {
        ...
        "category": "missing_fact",
        "message": "Half carcass Set A Riversdale delivery to 12 Test Street next week.",
        "expected_facts": {"product_type": "half_carcass", "delivery_or_collection": "delivery", "payment_method": "EFT"},
        "expected_reply_any": ["farm to review", "confirm price"],
        "expected_labels": ["meat_lead", "half_carcass", "set_a", "delivery", "needs_followup"],
    ...
    },
    {
        "id": "cut_set_missing",
        "category": "missing_fact",
        "message": "I want a half carcass in Riversdale, delivery to 12 Test Street, EFT, next week.",
        "expected_facts": {"product_type": "half_carcass"},
        "expected_reply_any": ["Which cut set", "Set A"],
        "expected_labels": ["meat_lead", "half_carcass", "delivery", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "collect_missing_facts"},
    },
    {
        "id": "town_missing",
        "category": "missing_fact",
        "message": "Half carcass Set A delivery please. EFT next week.",
    ...
    },
    {
        ...
        "expected_reply_any": ["Amadeus Signature Collection", "boneless neck steaks", "before quoting or booking"],
    ...
    },
    {
        ...
        "expected_facts": {},
        "expected_reply_any": ["Set A", "Set B", "Set C"],
        "expected_labels": ["meat_lead", "needs_followup"],
        "expected_attrs": {"meat_last_customer_intent": "asks_options"},
    },
    {
    ...
    },
    {
        ...
        "message": "I want the heaviest half carcass you have for Set A, delivery in Riversdale.",
        "expected_facts": {"product_type": "half_carcass", "cut_set": "Set A", "delivery_or_collection": "delivery"},
        "expected_reply_any": ["street address", "farm name", "directions"],
        "expected_labels": ["meat_lead", "half_carcass", "set_a", "delivery", "needs_followup"],
    ...
    },
    {
        ...
        "message": "Can I take a full carcass, Set B, delivery to 12 Test Street Albertinia, cash, next week?",
        "expected_facts": {
        ...
        "expected_labels": ["meat_lead", "full_carcass", "set_b", "delivery", "needs_followup"],
        "expected_attrs": {"meat_product_type": "full_carcass", "meat_next_gate": "owner_price_review"},
    },
    {
        "id": "cash_payment",
        "category": "payment",
        "message": "Half carcass Set A Riversdale delivery to 12 Test Street cash next week.",
    ...
    },
    {
        ...
        "message": "TEST FLOW - delete after test. Half carcass Set A Riversdale delivery to 12 Test Street EFT next week.",
        "expected_facts": {"product_type": "half_carcass", "cut_set": "Set A"},
    ...
    {
        "id": "collection_request_redirected_to_delivery",
    ...
    },
    {
        ...
        "category": "channel",
        "message": "Half carcass Set A Riversdale delivery to 12 Test Street EFT next week.",
    ...
    },
    {
        "id": "email_channel",
        "category": "channel",
        "message": "Please quote me on a full carcass Set C, delivery to 12 Test Street in Albertinia, EFT, next week.",
        ...
        "expected_reply_any": ["farm to review", "confirm"],
        "expected_labels": ["meat_lead", "full_carcass", "set_c", "delivery", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "owner_price_review"},
    },
    {
        "id": "outbound_ignored",
