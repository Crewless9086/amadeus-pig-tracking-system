...
STRESS_SCENARIOS = [
    ...
    },
    {
        ...
        "expected_facts": {"product_type": "unknown"},
        "expected_reply_any": ["pork", "half carcass", "full carcass"],
        "expected_labels": ["meat_lead", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "collect_missing_facts"},
        "known_gap": "Sam does not yet explicitly reject non-pork products; it redirects into pork options.",
    },
    {
    ...
    },
    {
        ...
        "expected_labels": ["meat_lead", "set_a", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "collect_missing_facts"},
        "known_gap": "Deterministic parser does not yet understand Afrikaans meat terms without LLM help.",
    },
    {
        "id": "typo_heavy",
        "category": "typos",
        ...
        "expected_labels": ["meat_lead", "set_a", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "collect_missing_facts"},
        "known_gap": "Heavy typo recovery currently depends on LLM extraction.",
    },
    {
    ...
    },
    {
        ...
        "expected_facts": {"delivery_or_collection": "delivery"},
        "expected_reply_any": ["delivery street address", "farm name", "directions"],
        "expected_labels": ["meat_lead", "delivery", "needs_followup"],
        "expected_attrs": {"meat_delivery_mode": "delivery"},
        "known_gap": "Plain-text Google Maps links are not yet parsed into coordinates without Chatwoot location metadata.",
    },
    {
        "id": "test_flow_marker",
    ...
    },
    {
        ...
        "expected_labels": ["meat_lead", "needs_followup"],
        "expected_attrs": {"meat_last_customer_intent": "asks_price"},
        "known_gap": "Sam does not yet add a softer frustration-specific acknowledgement.",
    },
    {
        "id": "slow_reply_yes",
        "category": "followup",
    ...
    },
    {
        ...
        "payload_overrides": {"created_at": "2026-06-15T00:00:00Z"},
        "expected_facts": {"product_type": "half_carcass"},
        "expected_reply_any": ["Which cut set", "Set A"],
        "expected_labels": ["meat_lead", "half_carcass", "needs_followup"],
        "expected_attrs": {"meat_next_gate": "collect_missing_facts"},
        "known_gap": "Runtime currently treats inbound messages as an open service window; closed-window handling is fulfilment/journey-side.",
    },
    {
        "id": "wants_invoice",
