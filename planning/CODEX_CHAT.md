...
```text
Deliver the data model slice of parent mission CHARLIE-HERDMASTER-PIG-OBSERVATIONS-20260720. Keep adjacent domains out of scope and record them as follow-ups.
```
...
```text
Mission ID: CHARLIE-SCOPE-1C564A1B7E1C7681
Mission title: Herdmaster Human Pig Observations and Triggered Decision Support: Data Model
Mission status at pickup: in_progress
Runner mode: code_test_pr
Vault stage: review_ready
```
