...
step mount_validation ca_missing_or_empty test -s /config/private-ca.crt
step mount_validation ca_unreadable test -r /config/private-ca.crt
...
step ca_install ca_install_failed install -o root -g root -m 0644 /config/private-ca.crt /etc/cups/ssl/site.crt
