"""Exact OMQ retained-report maintainer reconciliation; no public apply endpoint.
...
BASE = "a41b4a204d0de38a2ab99790e0827fcb3a34381b"
...
CANDIDATE_PR = 1349
HEAD = "3f4733e7ee29c839e6d36dc44a81a4ca0142e803"
APPROVED_RUNTIME_HEAD = HEAD
BRANCH = "codex/oom-retained-report-recovery-20260922"
PREDECESSOR_PR = 1348
PREDECESSOR_BASE = "72c216c223b250835d42cdd5299c2253016c7333"
PREDECESSOR_HEAD = "5c3d51e427b96063b194545855c474dc34a8a80c"
PREDECESSOR_BRANCH = "codex/oom-manager-delivery-recovery-20260922"
...
DECISION = "reconcile_exact_oom_retained_report_candidate"
TASK_ID = "01a0b9d5-5c55-7e30-a5fc-aea27c93ffd6"
REMOVED_EFFECTS = {"exact_pr1348_three_file_manager_delivery_replay_suppression",
    "application_revision_rollback:web:72c216c223b250835d42cdd5299c2253016c7333"}
ADDED_EFFECTS = {"exact_pr1349_six_file_retained_report_identity_recovery",
...
REQUIRED_ACCEPTANCE = {
    f"Release only the protected merge whose application tree equals exact PR1349 head {HEAD} to existing web {WEB_SERVICE}, only after protected merge and required checks.",
    ...
    "Verify exact loaded web revision and natural retained-report refresh with the same case identities, current canonical evidence and zero duplicate sends; missing litter/disposal facts and the non-atomic concurrent-cancellation boundary remain explicit limitations, not business completion or new protected-preview activation authority.",
}
