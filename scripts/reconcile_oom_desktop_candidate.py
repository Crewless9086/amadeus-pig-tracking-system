"""Exact OMQ manager-delivery maintainer reconciliation; no public apply endpoint.
...
BASE = "72c216c223b250835d42cdd5299c2253016c7333"
...
CANDIDATE_PR = 1348
HEAD = "5c3d51e427b96063b194545855c474dc34a8a80c"
APPROVED_RUNTIME_HEAD = HEAD
BRANCH = "codex/oom-manager-delivery-recovery-20260922"
PREDECESSOR_PR = 1347
PREDECESSOR_BASE = "e37c4d9ee446644914543e5977f57c8c7dc3e737"
PREDECESSOR_HEAD = "01887fc9507967c81004ba6c84020b04c4687bba"
PREDECESSOR_BRANCH = "codex/oom-runtime-readiness-20260922"
QUALIFICATION_TEST_PATHS = []
PATHS = [
    "modules/oom_sakkie/general_manager_worker.py",
    "tests/test_oom_sakkie_general_manager_delivery.py",
...
DECISION = "reconcile_exact_oom_manager_delivery_candidate"
TASK_ID = "01a0b9d5-5c55-7e30-a5fc-aea27c93ffd6"
REMOVED_EFFECTS = {"exact_oom_runtime_readiness_reviewed_candidate",
    f"existing_scheduler_application_release:{SCHEDULER_SERVICE}",
    "application_revision_rollback:web:e37c4d9ee446644914543e5977f57c8c7dc3e737",
    f"application_revision_rollback:scheduler:{SCHEDULER_SERVICE}:{SCHEDULER_ROLLBACK}"}
ADDED_EFFECTS = {"exact_pr1348_three_file_manager_delivery_replay_suppression",
    f"application_revision_rollback:web:{WEB_ROLLBACK}"}
REMOVED_FORBIDDEN_EFFECTS = {f"cron_deploy_other_than:{SCHEDULER_SERVICE}"}
ADDED_FORBIDDEN_EFFECTS = {"cron_deploy"}
...
REQUIRED_ACCEPTANCE = {
    f"Release only the protected merge whose application tree equals exact PR1348 head {HEAD} to existing web {WEB_SERVICE}, only after protected merge and required checks.",
    f"Require independently authenticated owner approval of the exact final candidate {HEAD}, manifest and web-only scope; no later candidate or qualification successor is authorized.",
    ...
    "Verify exact loaded web revision and genuine agent/owner journeys, including successful replay suppression without a borrowed generation receipt or duplicate send; source, CI, health and terminal-created fixtures are not business completion.",
}
