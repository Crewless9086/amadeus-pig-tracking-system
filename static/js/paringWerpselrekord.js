...
function fillLitter(litter) {
  ...
  setValue("pwr_weaned_male_total",litter.weaned_male_count);setValue("pwr_weaned_female_total",litter.weaned_female_count);renderRows((litter.piglets||[]).slice(0,PWR_ROW_COUNT));
}
